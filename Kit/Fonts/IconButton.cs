...
namespace media
{
    ...
    public class IconButton : PictureBox
    {
        ...
        /// </summary>
        public IconButton(int size = 24)
            : this(IconType.star, size, Color.DimGray, Color.Orange, false, null)
        {

            //Size = new Size(24, 24), ActiveColor = Color.Orange, InActiveColor = Color.DimGray
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //graphics.DrawString(IconChar, IconFont, Brushes.Transparent, new RectangleF(0, 0, w, h) );
        ...
        private static void InitialiseFont()
        {
            try
            {
                unsafe
                {
                    fixed (byte* pFontData = Resources.ionicons)
                    {
                        uint dummy = 0;
                        Fonts.AddMemoryFont((IntPtr)pFontData, Resources.ionicons.Length);
                        AddFontMemResourceEx((IntPtr)pFontData, (uint)Resources.ionicons.Length, IntPtr.Zero, ref dummy);
                    }
                }
            }
            catch
